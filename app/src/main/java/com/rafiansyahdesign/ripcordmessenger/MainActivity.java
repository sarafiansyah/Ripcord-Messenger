...
import com.rafiansyahdesign.ripcordmessenger.Adapter.OnItemClick;
import com.rafiansyahdesign.ripcordmessenger.Fragments.ChatsFragment;
import com.rafiansyahdesign.ripcordmessenger.Fragments.ProfileFragment;
import com.rafiansyahdesign.ripcordmessenger.Fragments.UsersFragment;
...
public class MainActivity extends AppCompatActivity implements OnItemClick {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case  R.id.about:
                startActivity(new Intent(MainActivity.this, Credits.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                return true;
        }
